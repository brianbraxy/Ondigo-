    ...
    <div class="box-body no-padding">
        <ul class="nav nav-pills nav-stacked flex-column">
			@if ($currency->type == 'fiat')
                ...
                <li {{ isset($list_menu) && $list_menu == 'nfcpayments' ? 'class=active' : '' }}>
                    <a data-spinner="true" href='{{ url(config('adminPrefix') . '/settings/payment-methods/nfcpayments/' . $currency->id) }}'>{{ __('NFCPayments') }}</a>
                </li>
