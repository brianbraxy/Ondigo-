...
@endif
<br><br><br>
<button><a  href="https://ondigo-ng.com/user/resources/views/user/merchant/register.blade.php"class="green-btn text-center cursor-pointer add-new-merchant bg-primary d-flex justify-content-center align-items-center">
        <span class="mb-0 f-14 leading-17 gilroy-medium text-white">+ {{ __('Register New Card') }}</span>
    </a></button>
