                ...
                <div class="col-md-6 col-12 col-xl-7">
                    ...
                    <div class="auth-section d-flex align-items-center create-account">
                        <div class="auth-module">
                            ...
                            <form action="{{ route('register.store') }}" class="form-horizontal" id="personal-info-form"
                                method="POST">
                                @csrf
                                ...
                                <div class="auth-module-header">
                                    ...
                                    <p class="mb-0 text-start auth-text mt-12"> {{ __('Already have an account?') }} <a
                                            href="{{ url('login') }}">{{ __('Sign in here') }}</a></p>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                            <label class="form-label">{{ __('Registeration Token') }} <span
                                                    class="star">*</span></label>
                                            <input type="text" class="form-control input-form-control" id="token"
                                                name="token"  required
                                    ...
                                    <div class="col-6">
                                        <div class="form-group mb-3">
                                            <label class="form-label">{{ __('Last Name') }} <span
                                                    class="star">*</span></label>
                                            <input type="text" class="form-control input-form-control" id="last_name"
                                                name="last_name" value="{{ old('last_name') }}" required
                                                data-value-missing="{{ __('This field is required.') }}" maxlength="30"
                                                data-max-length="{{ __(':x length should be maximum :y charcters.', ['x' => __('Last name'), 'y' => __('30')]) }}">
                                            @error('last_name')
                                                <span class="error"> {{ $message }} </span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="d-grid mb-3 mb-3p">
                                            <button style="background-color:#FFB329" class="btn btn-lg" type="submit"
                                                ...
                                                <span class="px-1"
                                                    id="registrationSubmitBtnTxt">{{ __('Continue') }}</span>
