                            ...
                            <div class="transaction-image">
                                <div class="static-image">
                                    <img class="img img-fluid"
                                        src="{{ asset('/frontend/templates/images/login/signin-static.svg') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <form action="{{ url('authenticate') }}" method="post" id="login-form">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        {{-- @if (isset($setting['login_via']) && $setting['login_via'] == 'email_only')
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="email" class="form-control input-form-control"
                                                    placeholder="{{ __('Email Address or phone number') }}" name="email_only"
                                        ...
                                        @elseif(isset($setting['login_via']) && $setting['login_via'] == 'phone_only')
                                            <div class="form-group mb-3">
                                                <label for="phone_only" class="form-label">{{ __('Phone') }} <span
                                                        class="star">*</span></label>
                                        ...
                                        @elseif(isset($setting['login_via']) && $setting['login_via'] == 'email_or_phone')
                                            <div class="form-group mb-3">
                                                <label for="email_or_phone" class="form-label">{{ __('Email or Phone') }}
                                                    <span class="star">*</span></label>
                                                <input type="text" class="form-control input-form-control"
                                                    placeholder="{{ __('Email or Phone') }}" name="email_or_phone"
                                        ...
                                        @endif --}}
                                        <input type="hidden" name="login_via" value="email_or_phone">
                                        <div class="form-group mb-3">
                                            <label for="email_or_phone" class="form-label">{{ __('Email or Phone') }}
                                                <span class="star">*</span></label>
                                            <input type="text" class="form-control input-form-control"
                                        ...
                                        <p class="mb-0 text-start auth-text mt-12"> <a href="{{ url('/login/agent') }}">
                                                {{ __('Agent Login') }}</a></p>
