        ...
        <div class="d-flex justify-content-between align-items-center r-pb-8 pb-10">
            ...
            <div class="d-flex align-items-center">
                ...
                <a class="fil-btn ml-12">
                    <img src="{{ asset('/dist/images/filter-on.svg') }}">
                    <img class="cross-none" src="{{ asset('/dist/images/filter-cross.svg') }}">
                </a>
            </div>
        </div>
...
@push('js')
    ...
    <script src="{{ asset('/user/customs/js/transaction.min.js') }}"></script>
@endpush